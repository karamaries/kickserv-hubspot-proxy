...
app.post("/send", async (req, res) => {
  ...
  try {
    ...
    // 1️⃣ Find or create parent company
    ...
    // 2️⃣ Find or create child company
    let companyId = null;
    ...
    // 3️⃣ Associate child to parent if both exist
    ...
    // 6️⃣ Associate deal with contact & company
    if (contactId) {
      await axios.put(
